...
* Dependency resolution with custom artifactories like JFrog by prioritizing the maven repositories configured with the mavenRepository and depsMavenRepository gradle properties over the default mavenCentral repository.
